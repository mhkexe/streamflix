...
import com.nextservices.nextvision.database.dao.EpisodeDao
import com.nextservices.nextvision.database.dao.MovieDao
import com.nextservices.nextvision.database.dao.SeasonDao
import com.nextservices.nextvision.database.dao.TvShowDao
    ...
    companion object {
        ...
        fun getInstance(context: Context): AppDatabase {
            val providerName = UserPreferences.currentProvider?.name
                ?: currentProviderName
                ?: run {
                    android.util.Log.e("AppDatabase", "getInstance: provider non impostato, uso fallback 'nextvision'")
                    "nextvision"
                }
        ...
        private val MIGRATION_9_10: Migration = object : Migration(9, 10) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE episodes ADD COLUMN runtime INTEGER")
            }
        }
    }
}
