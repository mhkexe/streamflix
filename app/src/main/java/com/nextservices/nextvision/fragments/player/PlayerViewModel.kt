...
import com.nextservices.nextvision.utils.CustomTabHelper
...
class PlayerViewModel(
    ...
    private fun getServers(videoType: Video.Type, id: String) = viewModelScope.launch(Dispatchers.IO) {
        ...
        try {
            ...
            Log.i("NextVisionES", "[SERVERS LIST] -> Provider: ${UserPreferences.currentProvider!!.name}")
            Log.i("NextVisionES", "[SERVERS LIST] -> Found ${servers.size} servers: ${servers.joinToString { it.name }}")
