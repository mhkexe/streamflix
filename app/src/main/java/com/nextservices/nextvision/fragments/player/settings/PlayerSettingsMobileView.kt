...
import com.nextservices.nextvision.databinding.ItemSettingMobileBinding
import com.nextservices.nextvision.databinding.ViewPlayerSettingsMobileBinding
                ...
                setOnClickListener {
                    when (item) {
                        ...
                        is Settings.Gestures -> {
                            when (item) {
                                is Settings.Gestures.On -> com.nextservices.nextvision.utils.UserPreferences.playerGestures = true
                                is Settings.Gestures.Off -> com.nextservices.nextvision.utils.UserPreferences.playerGestures = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }
                        ...
                        is Settings.KeepScreenOn -> {
                            when (item) {
                                is Settings.KeepScreenOn.On -> com.nextservices.nextvision.utils.UserPreferences.keepScreenOnWhenPaused = true
                                is Settings.KeepScreenOn.Off -> com.nextservices.nextvision.utils.UserPreferences.keepScreenOnWhenPaused = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }
