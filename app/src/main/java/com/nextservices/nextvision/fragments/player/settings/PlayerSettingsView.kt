...
import com.nextservices.nextvision.utils.OpenSubtitles
import com.nextservices.nextvision.utils.mediaServers
import com.nextservices.nextvision.utils.SubDL
import com.nextservices.nextvision.utils.SubtitleOffset
import com.nextservices.nextvision.utils.UserPreferences
import com.nextservices.nextvision.utils.dp
import com.nextservices.nextvision.utils.findClosest
import com.nextservices.nextvision.utils.getAlpha
import com.nextservices.nextvision.utils.getRgb
import com.nextservices.nextvision.utils.mediaServerId
import com.nextservices.nextvision.utils.mediaServers
import com.nextservices.nextvision.utils.setAlpha
import com.nextservices.nextvision.utils.setRgb
import com.nextservices.nextvision.utils.supportedTrackFormats
        ...
        sealed class Subtitle : Item {
            ...
            sealed class OpenSubtitles : Item {
                ...
                companion object : Settings.Subtitle() {
                    ...
                    fun init(openSubtitles: List<com.nextservices.nextvision.utils.OpenSubtitles.Subtitle>) {
                        list.clear()
                ...
                class Subtitle(
                    val openSubtitle: com.nextservices.nextvision.utils.OpenSubtitles.Subtitle
                ) : OpenSubtitles()
            }
            ...
            sealed class SubDLSubtitles : Item {
                ...
                companion object : Settings.Subtitle() {
                    ...
                    fun init(subDLSubtitles: List<com.nextservices.nextvision.utils.SubDL.Subtitle>) {
                        list.clear()
                ...
                class Subtitle(
                    val subDLSubtitle: com.nextservices.nextvision.utils.SubDL.Subtitle
                ) : SubDLSubtitles()
            }
        }
