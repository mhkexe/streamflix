...
open class FilemoonExtractor : Extractor() {
    ...
    override suspend fun extract(link: String): Video {
        ...
        Log.i("NextVisionES", "[Filemoon] Extraction started for: $link")

        // 1. Details
        val detailsUrl = "$currentDomain/api/videos/$videoId/embed/details"
        Log.i("NextVisionES", "[Filemoon] Details Request: $detailsUrl")
        ...
        Log.i("NextVisionES", "[Filemoon] Playback Domain detected: $playbackDomain")

        // 2. Challenge
        val challengeUrl = "$playbackDomain/api/videos/access/challenge"
        Log.i("NextVisionES", "[Filemoon] Challenge Request: $challengeUrl")
        ...
        Log.i("NextVisionES", "[Filemoon] Challenge Data: ID=$challengeId, Viewer=$viewerId")

        // 3. Attestation
        val attestation = generateAttestation(nonce)
        val attestUrl = "$playbackDomain/api/videos/access/attest"
        Log.i("NextVisionES", "[Filemoon] Attest Request: $attestUrl")
        ...
        Log.i("NextVisionES", "[Filemoon] Attest Token obtained (Confidence: $confidence)")

        // 4. Playback
        val playbackUrl = "$playbackDomain/api/videos/$videoId/embed/playback"
        Log.i("NextVisionES", "[Filemoon] Playback Request: $playbackUrl")
        ...
        Log.i("NextVisionES", "[Filemoon] Decrypting data...")
        ...
        Log.i("NextVisionES", "[Filemoon] SOURCE FOUND: $sourceUrl")
