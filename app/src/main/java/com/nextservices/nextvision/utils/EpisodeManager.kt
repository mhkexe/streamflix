...
import com.nextservices.nextvision.models.Video.Type.Episode
...
object EpisodeManager {
    ...
    fun convertToVideoTypeEpisodes(episodes: List<com.nextservices.nextvision.models.Episode>, database: AppDatabase, seasonNumber: Int): List<Episode> {
