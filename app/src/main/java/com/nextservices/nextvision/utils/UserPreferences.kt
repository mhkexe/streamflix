...
import com.nextservices.nextvision.providers.Provider.Companion.providers
...
object UserPreferences {
    ...
    var currentProvider: Provider?
        ...
        set(value) {
            val previousName = Key.CURRENT_PROVIDER.getString()
            if (previousName == value?.name) return
            ...
            runCatching {
                ArtworkRepairScheduler.schedule(NextVisionApp.instance, value)
            }
    ...
    var enableTmdb: Boolean
        ...
        set(value) {
            ...
            if (value) {
                runCatching {
                    ArtworkRepairScheduler.schedule(NextVisionApp.instance, currentProvider)
                }
            }
        }
    ...
    var dohProviderUrl: String
        get() = DEFAULT_DOH_PROVIDER_URL
        set(value) {
            DnsResolver.setDnsUrl(DEFAULT_DOH_PROVIDER_URL)
        }
